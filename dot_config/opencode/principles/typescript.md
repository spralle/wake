...
- **Barrel policy**: Use barrel files (index.ts) only when they preserve clear module boundaries and do not hide dependency direction. Avoid re-exporting everything.
